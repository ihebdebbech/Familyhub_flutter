...
class Teleportation extends SpriteAnimationComponent
    with HasGameReference, HasWorldReference<EndlessWorld> {
  Teleportation({required this.teleportpos}) : super(size: spriteSize, anchor: Anchor.bottomCenter);
 ...
 Vector2 teleportpos;
  ...
  Future<void> onLoad() async {
    ...
    animation = await game.loadSpriteAnimation(
      'dash/teleportationeffect5.png',
      SpriteAnimationData.sequenced(
        amount: 10,
        textureSize: Vector2(240, 270),
        stepTime: 0.1,
      ),
    );
